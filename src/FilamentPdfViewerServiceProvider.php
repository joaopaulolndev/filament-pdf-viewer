...
//        );
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filament-pdf-viewer/{$file->getFilename()}"),
                ], 'filament-pdf-viewer-stubs');
            }
        }
    ...
    {
        return [
            // AlpineComponent::make('filament-pdf-viewer', __DIR__ . '/../resources/dist/components/filament-pdf-viewer.js'),
            Css::make('filament-pdf-viewer-styles', __DIR__ . '/../resources/dist/filament-pdf-viewer.css'),
            Js::make('filament-pdf-viewer-scripts', __DIR__ . '/../resources/dist/filament-pdf-viewer.js'),
        ];
    }
    ...
    {
        return [
            'create_filament-pdf-viewer_table',
        ];
    }
}
